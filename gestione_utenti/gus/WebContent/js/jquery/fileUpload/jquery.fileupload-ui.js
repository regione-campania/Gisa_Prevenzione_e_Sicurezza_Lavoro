                	...
                	var jqxhr = $.ajax(data)
                		.done(function(res)
                		{
                			if( res.status == 'ok' )
                			{
                                ...
                                //setto il messaggio
                                $( "#mex-modal-p" )[0].innerHTML = '<strong>' + res.messaggio + '</strong>';
                                $( "#mex-modal-p" )[0].style.color = 'green';
                			}
                			else
                			{
                				//setto l'errore
                                $( "#mex-modal-p" )[0].innerHTML = '<strong>' + res.messaggio + '</strong>';
                                $( "#mex-modal-p" )[0].style.color = 'red';
                			}
                			$( "#mex-modal" ).dialog( "open" );
                		})
...
//                );
        ...
        _deleteHandler: function (e) {
            var button = $(this);
        	if( confirm("Sei sicuro di voler eliminare l'immagine '" + button.attr('nome-file') + "'?") )
        	{
	            e.preventDefault();
