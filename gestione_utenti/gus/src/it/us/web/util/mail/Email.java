 ...
 * @version $Revision: 1.1 $ $Date: 2007/09/14 10:34:52 $
 * @version $Id: Email.java,v 1.1 2007/09/14 10:34:52 gnave Exp $
 */
public abstract class Email
{
    ...
    */
	...
	public void setBcc(String bccElement) throws EmailException
    {
       this.bccList.add(createInternetAddress(bccElement, bccElement));
